...
def show_dcm(image):
    ...
    if isinstance(image, str):
        ...
        image_arr_scaled = (image_arr - image_arr.min()) / (image_arr.max() - image_arr.min())
...
#         model = ResNet(model_name=model_name, in_chans=inc_chans, 
#                        dropout_rate=dropout_rate, pretrained=pretrain, 
